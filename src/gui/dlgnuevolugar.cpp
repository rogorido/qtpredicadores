...
dlgNuevoLugar::dlgNuevoLugar(QWidget *parent)
    : QWidget(parent), ui(new Ui::dlgNuevoLugar)
{
  ui->setupUi(this);
  ...
  connect(ui->btOtrosNombres, SIGNAL(clicked(bool)), this,
          SLOT(anadirDetalles()));
...
dlgNuevoLugar::~dlgNuevoLugar() { delete ui; }
...
void dlgNuevoLugar::cerrar() { parentWidget()->close(); }
