...
WidgetExtraInfos::WidgetExtraInfos(QWidget *parent)
    : QWidget(parent), ui(new Ui::WidgetExtraInfos)
{
  ui->setupUi(this);
  ...
  connect(ui->btEliminarExtraInfo, SIGNAL(clicked(bool)), this,
          SLOT(eliminarPar()));
}

WidgetExtraInfos::~WidgetExtraInfos() { delete ui; }

ExtraInfos WidgetExtraInfos::getExtraInfos() { return extras; }
...
void WidgetExtraInfos::recibirConsultasCompleter(QString sql_claves,
                                                 QString sql_valores)
{
