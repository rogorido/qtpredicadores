...
SqlFiltroGestor::SqlFiltroGestor(QString sql, QObject *parent)
    : QObject(parent), sql_basico(sql)
{
}

void SqlFiltroGestor::setSqlGeneral(QString sql) { sql_basico = sql; }

void SqlFiltroGestor::setSqlOrder(QString sql) { sql_order = sql; }
